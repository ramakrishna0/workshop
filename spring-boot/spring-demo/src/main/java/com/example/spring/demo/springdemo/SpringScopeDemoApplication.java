...
//        ApplicationContext applicationContext = SpringApplication.run(SpringScopeDemoApplication.class, args);
        ApplicationContext applicationContext = new AnnotationConfigApplicationContext(SpringScopeDemoApplication.class);
